...
// 数据库配置
#define('DB_USER', 'eqinfoe7'); // 数据库用户名
define('DB_USER', 'root'); // 数据库用户
#define('DB_PASSWORD', 'eqinfo*7803%&120'); // 数据库密码
define('DB_PASSWORD', 'whzEQINFO'); // 数据库密码
#define('DB_NAME', 'shop_eqinfo_software'); // 数据库名
define('DB_NAME', 'shop_eqinfo_software'); // 数据库名
#define('DB_HOST', 'rm-wz9azo6x1vinlxhi9.mysql.rds.aliyuncs.com'); // 数据库HOST
